...
- [x] Local LLM (Mistral Uncensored) running efficiently
- [x] Chat UI with prompt/response streaming
- [x] Local memory via SQLite (conversation history)
- [x] Plugin folder for user-created extensions
- [x] Call mode (voice input/output)
